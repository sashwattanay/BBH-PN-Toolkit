...
BeginPackage[ "pkg`SeffLfl`"]
  ...
  Begin[ "`Private`"]
   ...
   SeffLflow[m1_, m2_, Rinit_,Pinit_,S1init_, S2init_,\[Lambda]max_,\[Lambda]0_]:=Module[{\[Mu],M,Q1,Q2,Linit,Jinit,RN,PN,S1N,S2N,LN,JN,
   SeffLN,Rn,Pn,S1n,S2n,Ln,Jn,SeffL,f0,\[Phi]L0,acos, \[Phi]R0, \[Phi]P0,X1,Y1,R1init,P1init,R1n,P1n,R1N,P1N,\[Phi]S10,\[Phi]R10, \[Phi]P10,X2,Y2,
...
Y2=Cross[S2init,X2];
Quiet[R2init={rx,ry,rz}/.Solve[Cross[{rx,ry,rz},{px,py,pz}]==S2init,{px,py,pz,rx,ry,rz}][[2]]/.{ry->1,py->1}]; 
Quiet [P2init={px,py,pz}/.Solve[Cross[{rx,ry,rz},{px,py,pz}]==S2init,{px,py,pz,rx,ry,rz}][[2]]/.{ry->1,py->1}];
...
B1=(1/2)((SeffL +Ln^2 (Q1+Q2))(Jn+Ln)+Ln(Q1  S1n^2+Q2  S2n^2+(Q1+Q2)(\[CapitalDelta]2 Q1 -\[CapitalDelta]1 Q2)));
B2=(1/2)((SeffL +Ln^2 (Q1+Q2))(Jn-Ln)-Ln(Q1  S1n^2+Q2  S2n^2+(Q1+Q2)(\[CapitalDelta]2 Q1 -\[CapitalDelta]1 Q2)));
D1=Ln(Ln+Jn)+(\[CapitalDelta]2 Q1 -\[CapitalDelta]1 Q2);D2=Ln(Ln-Jn)+(\[CapitalDelta]2 Q1 -\[CapitalDelta]1 Q2);
...
(*subspin space for spin S2*)
B1s2 =  1/2 (-Jn^2 S2n Q1+2 Jn S2n^2 Q1-S2n^3 Q1+Jn \[CapitalDelta]2 Q1^2-S2n \[CapitalDelta]2 Q1^2+Ln^2 S2n Q2-Jn S2n^2 Q2+S2n^3 Q2-Jn \[CapitalDelta]2 Q1 Q2+2 S2n \[CapitalDelta]2 Q1 Q2-S2n \[CapitalDelta]1 Q2^2) ;
...
\[Phi]L=\[Phi]L0-(2 ((B1 EllipticPi[\[Alpha]1sq,JacobiAmplitude[1/2 Sqrt[A (-f1+f3)] \[Alpha],k],k])/(D1+f1 (-Q1+Q2))+(B2 EllipticPi[\[Alpha]2sq,JacobiAmplitude[1/2 Sqrt[A (-f1+f3)] \[Alpha],k],k])/(D2+f1 (-Q1+Q2))))/Sqrt[A (-f1+f3)]+(2 ((B1 EllipticPi[\[Alpha]1sq,JacobiAmplitude[1/2 Sqrt[A (-f1+f3)] (\[Alpha]+\[Lambda]-\[Lambda]0),k],k])/(D1+f1 (-Q1+Q2))+(B2 EllipticPi[\[Alpha]2sq,JacobiAmplitude[1/2 Sqrt[A (-f1+f3)] (\[Alpha]+\[Lambda]-\[Lambda]0),k],k])/(D2+f1 (-Q1+Q2))))/Sqrt[A (-f1+f3)];
...
\[Phi]R=-(((Ln^2 (Q1+Q2)+SeffL+Q1 Q2 (\[CapitalDelta]1-\[CapitalDelta]2)) (\[Lambda]-\[Lambda]0))/Ln)+\[Phi]R0-(2 ((B1 EllipticPi[\[Alpha]1sq,JacobiAmplitude[1/2 Sqrt[A (-f1+f3)] \[Alpha],k],k])/(D1+f1 (-Q1+Q2))-(B2 EllipticPi[\[Alpha]2sq,JacobiAmplitude[1/2 Sqrt[A (-f1+f3)] \[Alpha],k],k])/(D2+f1 (-Q1+Q2))))/Sqrt[A (-f1+f3)]+(2 ((B1 EllipticPi[\[Alpha]1sq,JacobiAmplitude[1/2 Sqrt[A (-f1+f3)] (\[Alpha]+\[Lambda]-\[Lambda]0),k],k])/(D1+f1 (-Q1+Q2))-(B2 EllipticPi[\[Alpha]2sq,JacobiAmplitude[1/2 Sqrt[A (-f1+f3)] (\[Alpha]+\[Lambda]-\[Lambda]0),k],k])/(D2+f1 (-Q1+Q2))))/Sqrt[A (-f1+f3)];

\[Phi]P=-(((Ln^2 (Q1+Q2)+SeffL+Q1 Q2 (\[CapitalDelta]1-\[CapitalDelta]2)) (\[Lambda]-\[Lambda]0))/Ln)+\[Phi]P0-(2 ((B1 EllipticPi[\[Alpha]1sq,JacobiAmplitude[1/2 Sqrt[A (-f1+f3)] \[Alpha],k],k])/(D1+f1 (-Q1+Q2))-(B2 EllipticPi[\[Alpha]2sq,JacobiAmplitude[1/2 Sqrt[A (-f1+f3)] \[Alpha],k],k])/(D2+f1 (-Q1+Q2))))/Sqrt[A (-f1+f3)]+(2 ((B1 EllipticPi[\[Alpha]1sq,JacobiAmplitude[1/2 Sqrt[A (-f1+f3)] (\[Alpha]+\[Lambda]-\[Lambda]0),k],k])/(D1+f1 (-Q1+Q2))-(B2 EllipticPi[\[Alpha]2sq,JacobiAmplitude[1/2 Sqrt[A (-f1+f3)] (\[Alpha]+\[Lambda]-\[Lambda]0),k],k])/(D2+f1 (-Q1+Q2))))/Sqrt[A (-f1+f3)];
...
Rfinal=Flatten[Inverse[Emat] . ({
 {Rn Cos[\[Phi]R]},
 {Rn Sin[\[Phi]R]},
 {0}
})] (* in inertial frame*);
Pfinal=Flatten[Inverse[Emat] . ({
 {Pn Cos[\[Phi]P]},
 {Pn Sin[\[Phi]P]},
 {0}
})] (* in inertial frame*);
...
\[Phi]R1=(-Q1+Q2) S1n (\[Lambda]-\[Lambda]0)+\[Phi]R10+(2 ((B1s1 EllipticPi[\[Alpha]1s1sq,JacobiAmplitude[1/2 Sqrt[A (-f1+f3)] \[Alpha],k],k])/(D1s1+f1 Q1)-(B2s1 EllipticPi[\[Alpha]2s1sq,JacobiAmplitude[1/2 Sqrt[A (-f1+f3)] \[Alpha],k],k])/(D2s1+f1 Q1)))/Sqrt[A (-f1+f3)]+(-2 B1s1 (D2s1+f1 Q1) EllipticPi[\[Alpha]1s1sq,JacobiAmplitude[1/2 Sqrt[A (-f1+f3)] (\[Alpha]+\[Lambda]-\[Lambda]0),k],k]+2 B2s1 (D1s1+f1 Q1) EllipticPi[\[Alpha]2s1sq,JacobiAmplitude[1/2 Sqrt[A (-f1+f3)] (\[Alpha]+\[Lambda]-\[Lambda]0),k],k])/(Sqrt[A (-f1+f3)] (D1s1+f1 Q1) (D2s1+f1 Q1));

\[Phi]P1=(-Q1+Q2) S1n (\[Lambda]-\[Lambda]0)+\[Phi]P10+(2 ((B1s1 EllipticPi[\[Alpha]1s1sq,JacobiAmplitude[1/2 Sqrt[A (-f1+f3)] \[Alpha],k],k])/(D1s1+f1 Q1)-(B2s1 EllipticPi[\[Alpha]2s1sq,JacobiAmplitude[1/2 Sqrt[A (-f1+f3)] \[Alpha],k],k])/(D2s1+f1 Q1)))/Sqrt[A (-f1+f3)]+(-2 B1s1 (D2s1+f1 Q1) EllipticPi[\[Alpha]1s1sq,JacobiAmplitude[1/2 Sqrt[A (-f1+f3)] (\[Alpha]+\[Lambda]-\[Lambda]0),k],k]+2 B2s1 (D1s1+f1 Q1) EllipticPi[\[Alpha]2s1sq,JacobiAmplitude[1/2 Sqrt[A (-f1+f3)] (\[Alpha]+\[Lambda]-\[Lambda]0),k],k])/(Sqrt[A (-f1+f3)] (D1s1+f1 Q1) (D2s1+f1 Q1));
...
R1final=Flatten[Inverse[EmatS1] . ({
 {R1n Cos[\[Phi]R1]},
 {R1n Sin[\[Phi]R1]},
 {0}
})] (* in inertial frame*);
P1final=Flatten[Inverse[EmatS1] . ({
 {P1n Cos[\[Phi]P1]},
 {P1n Sin[\[Phi]P1]},
 {0}
})] (* in inertial frame*);
