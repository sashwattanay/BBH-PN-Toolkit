...
D1=Ln(Ln+Jn)+(\[CapitalDelta]2 Q1 -\[CapitalDelta]1 Q2);
D2=Ln(Ln-Jn)+(\[CapitalDelta]2 Q1 -\[CapitalDelta]1 Q2);
\[Alpha]1sq=((f2-f1) (Q1-Q2))/(D1-f1 (Q1-Q2));
\[Alpha]2sq=((f2-f1) (Q1-Q2))/(D2-f1 (Q1-Q2));
...
\[Alpha]1s1sq=((-Q1)(f2-f1) )/(D1s1+f1 Q1); 
\[Alpha]2s1sq=((-Q1)(f2-f1))/(D2s1+f1 Q1);
...
\[CapitalDelta]\[Lambda]5=(-1/(2 S2n))(4/Sqrt[A (f3-f1)] (-((B1s2 EllipticPi[\[Alpha]1s2sq,k])/(D1s2+f1 Q2))+(B2s2 EllipticPi[\[Alpha]2s2sq,k])/(D2s2+f1 Q2))+S2n (Q1-Q2) \[CapitalDelta]\[Lambda]1 ) ;
