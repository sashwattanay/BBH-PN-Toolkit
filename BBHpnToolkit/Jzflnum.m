...
BeginPackage[ "BBHpnToolkit`Jzflnum`"]
	...
	"NmJzflow implements flow along Jz in phase space numerically"
            ...
            NmJzflow[G_,m1_, m2_, Rinit_,Pinit_,S1init_, S2init_,\[Lambda]max_,\[Epsilon]_]:=
               Module[{c,Linit,Jinit,zhat,R,P,S1,S2,eqa,eqb,eqc,eqd,system0,initCond,
