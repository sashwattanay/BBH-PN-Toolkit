...
BeginPackage[ "pkg`Hflnum`"]
  ...
  Begin[ "`Private`"]
    ...
    NmHflow[m1_, m2_, Rinit_,Pinit_,S1init_, S2init_,\[Lambda]max_,\[Lambda]0_,\[Epsilon]_]:=
    Module[{G,c,precisionGoal,Q1,Q2,Linit,R,P,S1,S2,eqa,eqb,eqc,eqd,system0,initCond,
